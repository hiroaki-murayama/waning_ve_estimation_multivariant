...
overall_plot <- overall_ve %>% ggplot() + 
  ...
  labs(x="Week after two doses of vaccination",y="Cumulative number of fully vaccinated individuals") +
  ggtitle("Overall effect in Ontario") + theme_bw() +
  ...
  scale_y_continuous(breaks=seq(0,N,2000000),limit=c(0,N), expand = c(0, 0),
