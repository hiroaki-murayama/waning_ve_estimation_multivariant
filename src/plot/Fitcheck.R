...
unvaccinated = ncovdata$unvax_case[(l+2):(T+l)] + ncovdata$unknown[(l+2):(T+l)] * (ncovdata$unvax_case[(l+2):(T+l)]/(ncovdata$unvax_case[(l+2):(T+l)]+ncovdata$vax_case[(l+2):(T+l)])) 
vaccinated = ncovdata$vax_case[(l+2):(T+l)] + ncovdata$unknown[(l+2):(T+l)] * (ncovdata$vax_case[(l+2):(T+l)]/(ncovdata$unvax_case[(l+2):(T+l)]+ncovdata$vax_case[(l+2):(T+l)])) 
