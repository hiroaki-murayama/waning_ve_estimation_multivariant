...
unvaccinated = (ncovdata$unvax_case[(1+l):(T+l-1)] - ncovdata$exclusion[(1+l):(T+l-1)]) + ncovdata$unknown[(1+l):(T+l-1)] * ((ncovdata$unvax_case[(1+l):(T+l-1)] - ncovdata$exclusion[(1+l):(T+l-1)])/((ncovdata$unvax_case[(1+l):(T+l-1)] - ncovdata$exclusion[(1+l):(T+l-1)])+ncovdata$vax_case[(1+l):(T+l-1)])) 
vaccinated = ncovdata$vax_case[(1+l):(T+l-1)] + ncovdata$unknown[(1+l):(T+l-1)] * ((ncovdata$vax_case[(1+l):(T+l-1)] - ncovdata$exclusion[(1+l):(T+l-1)])/((ncovdata$unvax_case[(1+l):(T+l-1)] - ncovdata$exclusion[(1+l):(T+l-1)])+ncovdata$vax_case[(1+l):(T+l-1)]))
